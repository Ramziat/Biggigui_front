          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Vendez vos articles</h3>
                <p className="text-gray-600 mb-4">
                  Gagnez de l'argent en vendant ce que vous n'utilisez plus.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Protection Acheteur</h3>
                <p className="text-gray-600 mb-4">
                  Vos achats sont couverts par notre garantie satisfaction.
                </p>
