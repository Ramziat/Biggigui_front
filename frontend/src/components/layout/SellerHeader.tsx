...
export default function SellerHeader() {
  ...
  const navLinks = [
    { href: '/seller', label: 'Home', icon: HomeIcon },
    { href: '/seller/post', label: 'Post', icon: Plus },
    { href: '/seller/messages', label: 'Message', icon: MessageSquare },
  ...
  return (
    <header className="bg-white shadow-md">
        ...
        <div className="flex items-center justify-between py-4 gap-6">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <button className="flex items-center gap-2 hover:bg-gray-100 px-2 py-1 rounded-lg">
              <img
                src="https://ui-avatars.com/api/?name=Vendeur&background=FF6B35&color=fff"
                alt="Profil"
                className="w-8 h-8 rounded-full"
              />
              <span className="text-sm font-medium text-gray-800">Vendeur</span>
            </button>
      ...
      {/* Barre catégories (masquée sur la page Post) */}
      {pathname !== '/seller/post' && (
        <div className="bg-gray-50 border-t-2 border-gray-200">
          <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-3 py-4 text-sm flex-wrap">
